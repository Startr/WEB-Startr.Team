// Function to delete script elements with src="/.11ty/reload-client.js"
        ...
        document.addEventListener('dblclick', function (event) {
          ...
          // Pages without the inline-style editor widget (no #prompt /
          // #prompt_wrapper) must not throw on ordinary double-clicks,
          // e.g. double-click word selection while in Edit mode.
